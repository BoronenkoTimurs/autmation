  ...
  const tests = [
    ...
    },
    {
      ...
      test: async () => {
        ...
        await driver.wait(until.elementIsEnabled(catanLink), 3000)
        await driver.wait(until.elementIsVisible(catanLink), 3000)
    ...
    },
    {
      ...
      test: async () => {
        ...
        const banner = await driver.wait(until.elementLocated(By.css('section[role="log"][data-atc-banner][data-animation-state="open"]')), 3000)
